...
@section('content')
    <h1 class="text-3xl font-bold mb-4">Vehicle Permit Logs</h1>
    <table class="w-full table-auto">
        <thead class="bg-gray-100">
            <tr>
                <th class="px-4 py-2">ID</th>
                <th class="px-4 py-2">Vehicle Permit ID</th>
        ...
        <tbody>
            @foreach($vehiclePermitSmsLogs as $log)
                <tr class="hover:bg-gray-100">
                    <td class="px-4 py-2">{{ $log->id }}</td>
                    <td class="px-4 py-2">{{ $log->vehicle_permit_id }}</td>
