            ...
            <aside class="w-64 h-screen bg-gradient-to-b from-gray-800 to-gray-900 text-white shadow-lg flex-shrink-0">
                <div class="p-4">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li>
                            <a href="#" class="flex items-center px-4 py-2 text-lg font-semibold bg-gray-700 hover:bg-indigo-600 rounded-lg transition-colors duration-300 ease-in-out" onclick="toggleSubmenu()">
                                E-challan
                                <svg class="ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <ul id="submenu" class="space-y-4 pl-8" style="display: none;">
                                <li>
