...
@section('content')
    <h1 class="text-3xl font-bold mb-4">Environment Tax Logs</h1>
    <table class="w-full table-auto">
        <thead class="bg-gray-100">
            <tr>
                <th class="px-4 py-2">ID</th>
                <th class="px-4 py-2">Environment Tax ID</th>
        ...
        <tbody>
            @foreach($environmentTaxSmsLogs as $log)
                <tr class="hover:bg-gray-100">
                    <td class="px-4 py-2">{{ $log->id }}</td>
                    <td class="px-4 py-2">{{ $log->environment_tax_id }}</td>
